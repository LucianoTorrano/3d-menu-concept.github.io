...
function eventHandler(menuItem,elementColor,resetColor,target,liquidElement){
    
    menuItem.addEventListener('click',()=>{
        let evento = liquidElement.dispatchEvent(new KeyboardEvent('keydown', {key: 4 , charCode: 52,code: 'Digit4', path: '[body#liquid, html, document, Window]'}));
        console.log(evento)
    })
